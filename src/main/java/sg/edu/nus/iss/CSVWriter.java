...
public class CSVWriter {
    ...
    public List<Employee> generateEmployees() {
        ...
        Employee emp2 = new Employee("12345", "Lee", "Human Resources", "Hiring Manager", "lee@visa.com", 11000);
        Employee emp3 = new Employee("12346", "Bryant", "Technical Support", "Support Specialist", "bryant@visa.com", 12000);
